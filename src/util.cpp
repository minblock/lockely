...
const char * const BITCOIN_CONF_FILENAME = "lockely.conf";
const char * const BITCOIN_PID_FILENAME = "lockely.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Lockely";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Lockely";
#else
    // Unix
    return pathRet / ".lockely";
#endif
#endif
}
