...
const string strMessageMagic = "Lockelycoin Signed Message:\n";
...
bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Lockelycoin: Reject block.nVersion=1 blocks (mainnet >= 710000, testnet & regtest uses supermajority)
...
bool ContextualCheckBlock(const CBlock& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Lockelycoin: (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
