...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s lockely-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  lockely-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded lockely transaction") + "\n" +
              "  lockely-tx [options] -create [commands]   " + _("Create hex-encoded lockely transaction") + "\n" +
              "\n";
