...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Lockelycoin Core lockelycoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  lockelycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded lockelycoin transaction") + "\n" +
              "  lockelycoin-tx [options] -create [commands]   " + _("Create hex-encoded lockelycoin transaction") + "\n" +
              "\n";
