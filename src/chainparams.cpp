...
public:
    CMainParams() {
        ...
        genesis.nVersion = 1;
        genesis.nTime    = 1644793574;
        genesis.nBits    = 0x1e0ffff0;
        genesis.nNonce   = 786474;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0xcf4631b736baccef8690cc7f3b0201698199b1b1252fbd60ac585e1afbd5ce1d"));
        assert(genesis.hashMerkleRoot == uint256("0x28eea7b503f6c92566bd34ca2ea1814b21d9cdc121baddbc418dabf6c24f12e4"));

        //vSeeds.push_back(CDNSSeedData("lockelycointools.com", "dnsseed.lockelycointools.com"));
        //vSeeds.push_back(CDNSSeedData("lockelycoinpool.org", "dnsseed.lockelycoinpool.org"));
        ...
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.lockelycoin.loshan.co.uk"));
        ...
        // Lockelycoin: Mainnet v2 enforced as of block 710k
...
public:
    CTestNetParams() {
        ...
        genesis.nNonce = 793157;
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0xda76e83b6c5c87cd78d7b36e33173d40d54207d0aec1dff7ffea7a7fc9cd464d"));

        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("lockelycointools.com", "testnet-seed.lockelycointools.com"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.lockelycoin.loshan.co.uk"));
        ...
        // Lockelycoin: v2 enforced using Bitcoin's supermajority rule
...
public:
    CRegTestParams() {
        ...
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 19444;
        assert(hashGenesisBlock == uint256("0x2295a7143f99232ea21ed69f6c4eac277b2c80f9801ac4379dfb4a3b511a6ff6"));
