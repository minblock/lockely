...
{
    const char* pszTimestamp = "PGN Groundspankingtoday IfyoumentionoreventhinkaboutDisnelandoanybodychancesaretheirdoingmoretimethanyouandyoucangetstompedoutquickeggbranmcnuggetshisHelicopervroomvroomshisrighawaytothenearesthospitalalsoa#1sotheluckislowtobeholdshis!";
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S(" fc913a92617bc0a940be4f4c2fc337de5ffdd6a1298dddf4043236a7787c1c1b1");
        ...
        genesis = CreateGenesisBlock(1644121050, 380230, 0x1e0ffff0, 1, 50 * COIN);
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 106628, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x2e05227b4541c3a13d10acd8fd90f1da5907ad049741ebc4713ec36e1a749af4"));
        assert(genesis.hashMerkleRoot == uint256S("0x2fd2ed2819e593d35a11c9a9a641cf8dab2ebef85b6617bf5d9e26792f3f5658"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        //vSeeds.push_back(CDNSSeedData("lockelytools.com", "testnet-seed.lockelytools.com"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.lockely.loshan.co.uk", true));
...
public:
    CRegTestParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xcee0c52dc875d8e8581077609976bfe1e629ba92e606c83cad2a94598ba22d81"));
        assert(genesis.hashMerkleRoot == uint256S("0x2fd2ed2819e593d35a11c9a9a641cf8dab2ebef85b6617bf5d9e26792f3f5658"));
