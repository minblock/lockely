...
Testnet3 has been deprecated and replaced with Testnet4. The server port has been changed to 12000 however the RPC port remains
the same (111010).
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/minblock/lockelycoin/blob/master/src/chainparams.cpp#L220).
...
now ZMQ can be used on Windows. Please see [this document](https://github.com/minblock/lockelycoin/blob/master/doc/zmq.md) for
