...
([`valgrind.supp`](https://github.com/minblock/lockelycoin/blob/master/contrib/valgrind.supp))
...
- ThreadSocketHandler : Sends/Receives data from peers on port 11011.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 11010 for connections and services them.
