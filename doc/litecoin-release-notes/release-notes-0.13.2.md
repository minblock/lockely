...
Then, to tunnel a SSL connection on 211010 to a RPC server bound on localhost on port 19334 do:

    stunnel -d 211010 -r 127.0.0.1:19334 -p stunnel.pem -P ''
...
caching. A sample config for apache2 could look like:
    ...
    <Location /lockelycoinrpc>
        ProxyPass http://127.0.0.1:11010/
        ProxyPassReverse http://127.0.0.1:11010/
